...
let miFuncion : Function = Sumar;//referencia a una funcion

console.log(miFuncion(5, 5));//invocacion

//miFuncion = Saludar;

//console.log(miFuncion("Juan"));

let miVariable : Function = function(): void //es una funcion anonima
                {
                    console.log("hola");
                }
miVariable();

let varDespedir : void = Despedir();//aca se esta invocando. ACA
//console.log(varDespedir()) nos da error porque la estamos invocando arriba
